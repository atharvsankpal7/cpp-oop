...
public:
    ...
    //This code uses the whole class as an friend argument which means that any function of the calculator class can obtain the private data inside the complex class
